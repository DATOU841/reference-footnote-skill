...
0.5.0-dev expects 41 offline fixtures to pass.

Release gate requires an approved Claude review and a clean git worktree with tag `0.5.0-dev`.

0.5.0-dev keeps the 0.4 citation-specific gates and adds retrieval-first gates:
